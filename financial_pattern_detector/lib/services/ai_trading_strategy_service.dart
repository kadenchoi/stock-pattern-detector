...
class WatchlistTechnicalAnalysisService {
  static final WatchlistTechnicalAnalysisService instance =
      WatchlistTechnicalAnalysisService._();
  WatchlistTechnicalAnalysisService._();
  ...
  Future<Map<String, dynamic>?> analyzeSymbolTechnicalStrategy({
    ...
    try {
      ...
      // Use Firebase AI for technical analysis (no patterns needed)
      return await _analyzeTechnicalWithFirebaseAI(symbol, stockData);
    } catch (e) {
      print('Error analyzing symbol technical strategy: $e');
      // Fall back to basic technical analysis on AI service error
      return _generateBasicTechnicalAnalysis(symbol, stockData);
    }
  }

  Future<Map<String, dynamic>?> _analyzeTechnicalWithFirebaseAI(
      String symbol, StockDataSeries stockData) async {
    try {
      // Get trading strategy from Firebase AI using technical analysis
      final strategy = await _firebaseAI.analyzeTechnicalForStrategy(
        symbol: symbol,
      ...
      return _convertTechnicalStrategyToAnalysis(symbol, stockData, strategy);
    } catch (e) {
      print('Firebase AI technical analysis failed: $e');
      return _generateBasicTechnicalAnalysis(symbol, stockData);
    }
  }

  Map<String, dynamic> _convertTechnicalStrategyToAnalysis(
      String symbol, StockDataSeries stockData, TradingStrategy strategy) {
    final currentPrice =
  ...
  Map<String, dynamic> _generateBasicTechnicalAnalysis(
      String symbol, StockDataSeries stockData) {
    ...
    return {
      ...
      'educationalStrategy': {
        ...
        'riskFactors': _getRiskFactors(rsi, volume.toDouble(), avgVolume)
      },
